    ...
    test('Signup', async () => {
        vi.spyOn(usersApi, 'signup').mockImplementation(() =>
            Promise.resolve({
                ...
                config: {},
                headers: {},
                data: { user: { _id: '123', ...signupForm, createdAt: new Date().toLocaleDateString(), updatedAt: new Date().toLocaleDateString(), avatar: '' }, token: '123' }
            })
        );
    ...
    test('Update User', async () => {
        vi.spyOn(usersApi, 'updateUser').mockImplementation(() =>
            Promise.resolve({
                ...
                config: {},
                headers: {},
                data: { user: { _id: '123', ...updateUserForm, createdAt: new Date().toLocaleDateString(), updatedAt: new Date().toLocaleDateString(), avatar: '' }, nModified: 1 }
            })
        );
